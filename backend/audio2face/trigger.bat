...
@REM echo Starting all services with pm2 using ecosystem.config.js...
@REM start "" pm2 start "C:/Users/mynam/Downloads/holobox/ecosystem.config.js"
...
@REM echo Running Unreal Engine...
@REM start "" "C:\Users\mynam\Desktop\UE\UE.exe"
